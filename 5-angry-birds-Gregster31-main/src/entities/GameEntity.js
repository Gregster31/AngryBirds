...
export default class GameEntity {
	static DAMAGE_THRESHOLD_SCALAR = 20;
	static GLASS_DAMAGE_THRESHOLD_SCALAR = 10;
	...
	calculateDensity() {
		// Change to a lower density, if glass block
		if(this.body.label == 'glassblock') {
			this.body.damageThreshold = this.body.mass * GameEntity.GLASS_DAMAGE_THRESHOLD_SCALAR;
		} else {
